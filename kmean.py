...
def computeCenter(df, k, cluster_labels):
    ...
    for i in range(k):
        ...
        #cluster_centers.append(map(mean, list(zip(*data_points))))
...
k = 2
MAX_ITER = 100 
df_full = pd.read_csv(r'C:\Users\chandan sharma\Desktop\research\majorproject\ppr1\K-Means-master\SPECTF_New.csv')
